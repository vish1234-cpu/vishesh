<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ques6.aspx.cs" Inherits="ADO_DOT_NET_ASSIGNMENT.ques6" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal">
            ...
            <br />
            <asp:Label ID="Label1" runat="server" Text="wanna see transaction:press the button "></asp:Label>
            <br />
            <br />
